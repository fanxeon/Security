...
public class DesConstant {
	...
	public static int[] shiftKey = { 1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2,
			2, 1 };
	// expand permutation from function f
	public static int[] expandTable = { 32, 1, 2, 3, 4, 5, 4, 5, 6, 7, 8, 9, 8,
